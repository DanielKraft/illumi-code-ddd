...
public class AggregateRootRefactorServiceTest {
    ...
    void init() {
        ...
        model = (Package) ((Package) refactorData.getDomainModule().getContains().get(0)).getContains().get(0);
    ...
    void testRefactorAggregateRoot() {
        ...
        assertAll(  () -> assertEquals(3, refactorData.getNewStructure().getClasses().size(), "#Class"),
    ...
    void testRefactorInvalidAggregateRoot() {
        assertAll(  () -> assertEquals(1, refactorData.getNewStructure().getClasses().size(), "#Class"),
    ...
    void testRefactorInvalidAggregateRootWithEntity() {
        ...
        assertAll(  () -> assertEquals(2, refactorData.getNewStructure().getClasses().size(), "#Class"),
                    () -> assertEquals(0, refactorData.getNewStructure().getInterfaces().size(), "#Interface"));
    ...
    void testRefactorAggregateRootWithOtherInterfaces() {
        ...
        assertAll(  () -> assertEquals(5, refactorData.getNewStructure().getClasses().size(), "#Class"),
