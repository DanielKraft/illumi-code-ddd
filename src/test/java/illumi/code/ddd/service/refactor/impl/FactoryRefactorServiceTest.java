...
class FactoryRefactorServiceTest {
    ...
    void testRefactorFactory() {
        ...
        assertAll(  () -> assertEquals("de.test.domain0.EntityFactory", artifact.getPath(), "path"),
    ...
    void testRefactorInvalidFactoryWithoutImpl() {
        ...
        assertAll(  () -> assertEquals("de.test.domain0.EntityTestFactory", artifact.getPath(), "path"),
                    () -> assertEquals(1, artifact.getMethods().size(), "#Method"),
                    () -> assertEquals(2, refactorData.getNewStructure().getInterfaces().size(), "#Interface"),
                    () -> assertEquals(5, refactorData.getNewStructure().getClasses().size(), "#Class"));
    }
    ...
    void testRefactorFactoryImpl() {
        ...
        assertAll(  () -> assertEquals("de.test.domain0.impl.EntityFactoryImpl", artifact.getPath(), "path"),
                    () -> assertEquals(1, artifact.getMethods().size(), "#Method"),
                    () -> assertEquals(2, refactorData.getNewStructure().getInterfaces().size(), "#Interface"),
                    () -> assertEquals(5, refactorData.getNewStructure().getClasses().size(), "#Class"));
    }
    ...
    void testRefactorInvalidFactoryImplWithoutInterface() {
        ...
        assertAll(  () -> assertEquals("de.test.domain0.EntityTestFactoryImpl", artifact.getPath(), "path"),
                    () -> assertEquals(1, artifact.getMethods().size(), "#Method"),
                    () -> assertEquals(2, refactorData.getNewStructure().getInterfaces().size(), "#Interface"),
                    () -> assertEquals(5, refactorData.getNewStructure().getClasses().size(), "#Class"));
    }
    ...
    void testInvalidStructure() {
        ...
        assertAll(  () -> assertEquals("de.test.domain0.impl.TestFactoryImpl", artifact.getPath(), "path"),
