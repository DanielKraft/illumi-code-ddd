...
class RepositoryRefactorServiceTest {
    ...
    void testRefactorInvalidRepository() {
        ...
        fitness.addFailedCriteria(DDDIssueType.MAJOR, "The Repository '%s' has no nextIdentity method.");
        fitness.addFailedCriteria(DDDIssueType.MAJOR, "The Repository '%s' has no findBy/get method.");
        fitness.addFailedCriteria(DDDIssueType.MAJOR, "The Repository '%s' has no save/add/insert/put method.");
        fitness.addFailedCriteria(DDDIssueType.MAJOR, "The Repository '%s' has no delete/remove method.");
        fitness.addFailedCriteria(DDDIssueType.MINOR, "The Repository '%s' has no contains/exists method.");
        fitness.addFailedCriteria(DDDIssueType.MINOR, "The Repository '%s' has no update method.");
        fitness.addFailedCriteria(DDDIssueType.INFO, "The invalid Repository name");
    ...
    void testRefactorRepository() {
        ...
        repoImpl.addMethod(new Method("public", "nextIdentity", "de.test.EntityId nextIdentity()"));
        repoImpl.addMethod(new Method("public", "findById", "de.test.Entity findById(de.test.EntityId)"));
        repoImpl.addMethod(new Method("public", "save", "void save(de.test.Entity)"));
        repoImpl.addMethod(new Method("public", "delete", "void delete(de.test.Entity)"));
        repoImpl.addMethod(new Method("public", "contains", "java.lang.Boolean contains(de.test.Entity)"));
        repoImpl.addMethod(new Method("public", "update", "void update(de.test.Entity)"));
        ...
        assertAll(  () -> assertEquals("de.test.domain0.EntityRepository", repo.getPath(), "path"),
                    () -> assertEquals(6, repo.getMethods().size(), "#Method"),
    ...
    void testRefactorInvalidImplRepository() {
        ...
        assertAll(  () -> assertEquals("de.test.domain0.impl.EntityTestRepositoryImpl", repoImpl.getPath(), "path"),
                    () -> assertEquals(6, repoImpl.getMethods().size(), "#Method"));
    }
    ...
    void testFindIdOfSuperclass() {
        ...
        assertAll(  () -> assertEquals("de.test.domain0.OtherRepository", repo.getPath(), "path"),
                    () -> assertEquals(6, repo.getMethods().size(), "#Method"));
    }
    ...
    void testRefactorWithoutRepository() {
        ...
        assertAll(  () -> assertEquals(4, refactorData.getNewStructure().getClasses().size(), "#Class"),
